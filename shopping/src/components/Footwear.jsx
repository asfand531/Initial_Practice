...
import "../App.css";
import image1 from "../assets/images/footwear-1.jpg";
import image2 from "../assets/images/footwear-2.jpg";
  ...
  const [cardData, setCardData] = useState([
    {
      ...
      fabric: "Leather",
      category: "Trendy",
      product_category: "Peshawari Chappal",
      dis_percent: 25,
      dis_price: 5999.0,
      ori_price: 7990.0,
      image: image1,
    ...
    <div className="main-container">
      ...
      <section className="ks-container">
        {filteredData.map((item) => (
          ...
          >
            <Meta
              title={`${item.color} ${item.category} ${item.product_category}`}
              description={
                <>
                  <span>
