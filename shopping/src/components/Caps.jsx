...
import "../App.css";
import image1 from "../assets/images/cap-1.jpg";
import image2 from "../assets/images/cap-2.jpg";
import image3 from "../assets/images/cap-3.jpg";
import image4 from "../assets/images/cap-4.jpg";
    ...
    <div className="main-container">
      ...
      <section className="ks-container">
        {filteredData.map((item) => (
          ...
          >
            <Meta
              title={`${item.color} ${item.fabric} ${item.category}`}
              description={
                <>
                  <span>
